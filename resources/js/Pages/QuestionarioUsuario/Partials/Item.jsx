export default function Item({ questao, onActivate }) {
    ...
    return (
        <div onClick={() => onActivate(questao)} className={`p-5 flex space-x-2 bg-gray-900 rounded-md  border-spacing-2 border-2 border-dashed cursor-pointer ${questao.ativa ? "border-gray-50" : "border-gray-500" }`}>
