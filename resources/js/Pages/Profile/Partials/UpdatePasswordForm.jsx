...
export default function UpdatePasswordForm({ className = '' }) {
    ...
    return (
        <section className={className}>
            <header>
                <h2 className="text-lg font-medium text-gray-900 dark:text-gray-100">Mudar senha</h2>

                <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
                    Assegure que sua conta está usando uma senha longa e aleatória para se manter segura.
                </p>
            </header>
